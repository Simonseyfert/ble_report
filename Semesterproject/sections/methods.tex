...
are discussed in Section~\ref{sec:results_ble}.
...
Electrical stimulation delivers charge-balanced biphasic current pulses via a
...
gap is timed in hardware. The stimulation pipeline is predominantly hardware-driven
